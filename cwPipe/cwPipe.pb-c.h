...
#ifndef PROTOBUF_C_cwPipe_2eproto__INCLUDED
#define PROTOBUF_C_cwPipe_2eproto__INCLUDED
...
typedef struct _Iot__Service__CwPipe__Properties Iot__Service__CwPipe__Properties;
...
struct  _Iot__Service__CwPipe__Properties
{
...
#define IOT__SERVICE__CW_PIPE__PROPERTIES__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&iot__service__cw_pipe__properties__descriptor) \
    , 0, 0, 0, 0, 0, 0 }


/* Iot__Service__CwPipe__Properties methods */
...
typedef void (*Iot__Service__CwPipe__Properties_Closure)
                 (const Iot__Service__CwPipe__Properties *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor iot__service__cw_pipe__properties__descriptor;

PROTOBUF_C__END_DECLS


#endif  /* PROTOBUF_C_cwPipe_2eproto__INCLUDED */
