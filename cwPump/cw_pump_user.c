#include "schema/cwPump/cw_pump_service.h"
#include "heythings.h"
...
int32_t cw_pump_properties_write_cb(size_t count, uint32_t *enumerate, struct cw_pump_properties *properties)
{
    ...
    return cw_pump_properties_update(count, enumerate, properties);
}
