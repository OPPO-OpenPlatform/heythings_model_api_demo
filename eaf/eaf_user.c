#include "schema/eaf/eaf_service.h"
#include "heythings.h"
...
int32_t eaf_properties_write_cb(size_t count, uint32_t *enumerate, struct eaf_properties *properties)
{
    ...
    return eaf_properties_update(count, enumerate, properties);
}
