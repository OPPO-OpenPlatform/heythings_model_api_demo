#include "schema/fcu/fcu_service.h"
#include "heythings.h"
...
int32_t fcu_properties_write_cb(size_t count, uint32_t *enumerate, struct fcu_properties *properties)
{
    ...
    return fcu_properties_update(count, enumerate, properties);
}
